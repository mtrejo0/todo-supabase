...
export function FolderSidebar({ folders, activeFolderId, onFolderSelect, isSidebarOpen, onClose }: FolderSidebarProps) {
  ...
  return (
    <>
      ...
      <div className={`
        ...
        w-64 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 p-4
      ...
      `}>
        ...
        <button
          onClick={onClose}
          className="md:hidden absolute top-4 right-4 p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg transition-colors"
